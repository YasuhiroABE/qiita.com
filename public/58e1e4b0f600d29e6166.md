---
title: Kubernetes環境のsameersbn版GitLab 15.11.13を最新版にしてみた
tags:
  - GitLab
  - kubernetes
private: false
updated_at: '2026-03-13T16:02:42+09:00'
...
:::note
【2026/03/13】 この記事では主にv16.x.xからv17.x.xの頃に遭遇した障害などについてまとめています。

v18.0.1にアップグレードしてからは、v18.9.2まで順調にアップグレードして利用し続けています。

しかし場合によっては対応が必要なので、[Upgrade Path](https://gitlab-com.gitlab.io/support/toolbox/upgrade-path/)と[Upgrade Guide](https://docs.gitlab.com/update/)は必ず確認するようにしてください。
:::
